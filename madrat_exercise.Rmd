...
# Note that some regions have now been turned into NA; 
# It would be important to check that no information is lost. In this case they are mostly WB aggregate regions. 
library(countrycode)
