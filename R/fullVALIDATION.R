...
fullVALIDATION <- function(rev=0.1) {
  ...
  calcOutput("ValidCarbonStocks",datasource="LPJmL_natural",aggregate="REG+GLO", file=valfile, append=TRUE, try=TRUE)
  ...
  calcOutput(type="ValidPriceAgriculture", datasource="FAOp", aggregate="REG+GLO", file=valfile, append=TRUE, try=TRUE)
